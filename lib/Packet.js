...
module.exports = {
    ...
    packAnnounce: function(name, tcpPort, udpPort) {
        ...
        // Write the type
        message.writeUInt8(this.ANNOUNCE, 4);
    ...
    packData: function(typeName, data, reliable, multicast) {
        ...
        var messageId = this.packetIDSource = (this.packetIDSource + 1) % (Math.pow(2, 16) - 1);
        var messages = [];
